...
import { Clock, Map, AlertTriangle, Phone } from 'lucide-react';
const actions = [
{
  title: 'Check Wait Times',
  description: 'Live updates for all major crossing points.',
  icon: Clock,
  color: 'text-[#00e5c7]'
},
{
  title: 'Plan Your Route',
  description: 'Optimize travel with traffic intelligence.',
  icon: Map,
  color: 'text-[#0ea5e9]'
},
{
  title: 'Report an Issue',
  description: 'Submit observations from the field.',
  icon: AlertTriangle,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <motion.div
          ...
          className="glass-panel p-6 rounded-xl group cursor-pointer transition-all duration-300 hover:-translate-y-1">
            ...
            <div
            className={`p-3 rounded-lg bg-white/5 w-fit mb-4 group-hover:bg-white/10 transition-colors ${action.color}`}>
